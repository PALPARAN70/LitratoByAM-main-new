...
export default function DashboardPage() {
  ...
  const badgeClass = (s: Row['status']) => {
    ...
    if (s === 'Declined') return 'bg-red-700 text-white border border-red-300'
    if (s === 'Cancelled')
      return 'bg-orange-700 text-white border border-orange-300'
    return 'bg-gray-700 text-white border border-gray-300'
  }
