...
function BookingsPanel({
  ...
  return (
    <div className="flex gap-2 p-2">
      ...
      <div className="flex flex-col p-2 bg-gray-300 h-119 flex-1 rounded">
        ...
        <div className="rounded bg-white p-2 h-full overflow-y-auto flex flex-col">
          {selectedISODate ? (
            ...
            <div className="space-y-3 pr-2">{fields.map(renderField)}</div>
          )}
