...
// Junction table: booking_requests <-> grids (many-to-many, but limited to 2 in app logic)
// Schema
//   booking_request_grids (
//     requestid INTEGER REFERENCES booking_requests(requestid) ON DELETE CASCADE,
//     grid_id   INTEGER REFERENCES grids(id) ON DELETE RESTRICT,
